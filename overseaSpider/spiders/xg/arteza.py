...
site_name = 'arteza'  # 站名 如 'shopweareiconic'
domain_name = 'arteza.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://arteza.com'  # URL 前缀 如 'https://shopweareiconic.com'
