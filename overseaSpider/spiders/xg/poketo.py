...
site_name = 'poketo'  # 站名 如 'shopweareiconic'
domain_name = 'poketo.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.poketo.com'  # URL 前缀 如 'https://shopweareiconic.com'
