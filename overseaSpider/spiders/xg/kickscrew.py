...
site_name = 'kickscrew'  # 站名 如 'shopweareiconic'
domain_name = 'kickscrew.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.kickscrew.com'  # URL 前缀 如 'https://shopweareiconic.com'
