...
site_name = 'geebeauty'  # 站名 如 'shopweareiconic'
domain_name = 'geebeauty.ca'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://geebeauty.ca'  # URL 前缀 如 'https://shopweareiconic.com'
