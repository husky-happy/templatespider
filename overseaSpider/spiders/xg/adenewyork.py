...
site_name = 'adenewyork'  # 站名 如 'shopweareiconic'
domain_name = 'adenewyork.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://adenewyork.com'  # URL 前缀 如 'https://shopweareiconic.com'
