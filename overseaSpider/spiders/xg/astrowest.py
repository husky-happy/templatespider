...
site_name = 'astrowest'  # 站名 如 'shopweareiconic'
domain_name = 'astrowest.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://astrowest.com'  # URL 前缀 如 'https://shopweareiconic.com'
