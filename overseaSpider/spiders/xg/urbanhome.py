...
site_name = 'urbanhome'  # 站名 如 'shopweareiconic'
domain_name = 'urbanhome.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://urbanhome.com'  # URL 前缀 如 'https://shopweareiconic.com'
