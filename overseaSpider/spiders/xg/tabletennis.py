...
site_name = 'tabletennis'  # 站名 如 'shopweareiconic'
domain_name = 'newgy.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.newgy.com'  # URL 前缀 如 'https://shopweareiconic.com'
