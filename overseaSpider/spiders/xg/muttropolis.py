...
site_name = 'muttropolis'  # 站名 如 'shopweareiconic'
domain_name = 'shop.greatpetcare.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://shop.greatpetcare.com'  # URL 前缀 如 'https://shopweareiconic.com'
