...
site_name = 'skint-shop'  # 站名 如 'shopweareiconic'
domain_name = 'skint-shop.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://skint-shop.com'  # URL 前缀 如 'https://shopweareiconic.com'
