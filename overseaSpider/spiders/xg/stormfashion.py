...
site_name = 'stormfashion'  # 站名 如 'shopweareiconic'
domain_name = 'stormfashion.dk'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://stormfashion.dk'  # URL 前缀 如 'https://shopweareiconic.com'
