...
site_name = 'openfarmpet'  # 站名 如 'shopweareiconic'
domain_name = 'openfarmpet.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://openfarmpet.com'  # URL 前缀 如 'https://shopweareiconic.com'
