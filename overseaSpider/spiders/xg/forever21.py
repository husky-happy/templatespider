...
site_name = 'forever21'  # 站名 如 'shopweareiconic'
domain_name = 'forever21.ca'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://forever21.ca'  # URL 前缀 如 'https://shopweareiconic.com'
