...
site_name = 'fragrancesandcosmetics'  # 站名 如 'shopweareiconic'
domain_name = 'freshbeautyco.com.au'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://freshbeautyco.com.au'  # URL 前缀 如 'https://shopweareiconic.com'
