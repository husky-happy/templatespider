...
site_name = 'standarddose'  # 站名 如 'shopweareiconic'
domain_name = 'standarddose.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://standarddose.com'  # URL 前缀 如 'https://shopweareiconic.com'
