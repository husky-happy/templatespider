...
site_name = 'terminal27'  # 站名 如 'shopweareiconic'
domain_name = 'terminal27.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://terminal27.com'  # URL 前缀 如 'https://shopweareiconic.com'
