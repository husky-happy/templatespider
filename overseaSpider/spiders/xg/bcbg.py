...
site_name = 'bcbg'  # 站名 如 'shopweareiconic'
domain_name = 'bcbg.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://bcbg.com'  # URL 前缀 如 'https://shopweareiconic.com'
