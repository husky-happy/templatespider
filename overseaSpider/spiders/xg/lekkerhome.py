...
site_name = 'lekkerhome'  # 站名 如 'shopweareiconic'
domain_name = 'lekkerhome.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://lekkerhome.com'  # URL 前缀 如 'https://shopweareiconic.com'
