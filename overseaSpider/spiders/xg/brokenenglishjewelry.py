...
site_name = 'brokenenglishjewelry'  # 站名 如 'shopweareiconic'
domain_name = 'brokenenglishjewelry.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://brokenenglishjewelry.com'  # URL 前缀 如 'https://shopweareiconic.com'
