...
site_name = 'cottagedoorpress'  # 站名 如 'shopweareiconic'
domain_name = 'cottagedoorpress.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://cottagedoorpress.com'  # URL 前缀 如 'https://shopweareiconic.com'
