...
site_name = 'perfumenz'  # 站名 如 'shopweareiconic'
domain_name = 'perfumenz.co.nz'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.perfumenz.co.nz'  # URL 前缀 如 'https://shopweareiconic.com'
