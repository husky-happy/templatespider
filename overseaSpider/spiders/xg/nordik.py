...
site_name = 'nordik'  # 站名 如 'shopweareiconic'
domain_name = 'nordik.design'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://nordik.design'  # URL 前缀 如 'https://shopweareiconic.com'
