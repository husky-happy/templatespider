...
site_name = 'aliveskinhair'  # 站名 如 'shopweareiconic'
domain_name = 'aliveskinhair.com.au'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://aliveskinhair.com.au'  # URL 前缀 如 'https://shopweareiconic.com'
