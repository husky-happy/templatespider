...
site_name = 'adornmonde'  # 站名 如 'shopweareiconic'
domain_name = 'adornmonde.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://www.adornmonde.com'  # URL 前缀 如 'https://shopweareiconic.com'
