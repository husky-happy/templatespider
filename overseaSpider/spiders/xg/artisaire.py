...
site_name = 'artisaire'  # 站名 如 'shopweareiconic'
domain_name = 'artisaire.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://artisaire.com'  # URL 前缀 如 'https://shopweareiconic.com'
