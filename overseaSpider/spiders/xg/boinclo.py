...
site_name = 'boinclo'  # 站名 如 'shopweareiconic'
domain_name = 'boinclo.co.uk'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://boinclo.co.uk'  # URL 前缀 如 'https://shopweareiconic.com'
