...
site_name = 'fanmdjanm'  # 站名 如 'shopweareiconic'
domain_name = 'fanmdjanm.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://fanmdjanm.com'  # URL 前缀 如 'https://shopweareiconic.com'
