...
site_name = 'jazzupco'  # 站名 如 'shopweareiconic'
domain_name = 'jazzupco.com'  # 完整域名 如 'shopweareiconic.com'
url_prefix = 'https://jazzupco.com'  # URL 前缀 如 'https://shopweareiconic.com'
