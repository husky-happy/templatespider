...
website = 'exclusivedogsupplies'
website_url = 'https://www.exclusivedogsupplies.com/'
...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['exclusivedogsupplies.com']
    start_urls = ['https://www.exclusivedogsupplies.com/']
    ...
    def parse_detail(self, response):
        ...
        items["source"] = 'exclusivedogsupplies.com'
        ...
        if len(sku_variant)<1:
            ...
            # print(attrs_list)
            headers = {
                'authority': 'www.exclusivedogsupplies.com',
                ...
                'accept': '*/*',
                'origin': 'https://www.exclusivedogsupplies.com',
                'sec-fetch-site': 'same-origin',
                'sec-fetch-mode': 'cors',
                'sec-fetch-dest': 'empty',
                'accept-language': 'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7,an;q=0.6',
                'cookie': 'zenid=vp7d1b5h0729pvptvcf5p8k76a; _ga=GA1.2.2129521568.1640656670; _gid=GA1.2.1277914808.1640656670; velaro_endOfDay=%222021-12-27T23%3A59%3A59.999Z%22; velaro_visitorId=%22N-I5BcOSm0K7H1njWbgXAQ%22; velaro_firstvisit=%222021-12-28T01%3A58%3A01.16Z%22; __atuvc=7%7C52; __atuvs=61ca79bc72a44ea9004',
            }
            sku_list = list()
            for attrs in attrs_list:
                ...
                data = {
                    'securityToken': 'aa126285b868aac0a3372e2ee8033fcf',
                    # 'id[87]': '863',
                    # 'id[92]': '908',
                    # 'id[88]': '881',
                    # 'id[101]': '1545',
                ...
                response = requests.post('https://www.exclusivedogsupplies.com/ajax.php', headers=headers, params=params, data=data)
