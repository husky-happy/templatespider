...
website = 'english-bulldog-dog-breed'
website_url = 'https://www.english-bulldog-dog-breed.com/'
...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['english-bulldog-dog-breed.com']
    start_urls = ['https://www.english-bulldog-dog-breed.com/']
    ...
    def parse_detail(self, response):
        ...
        items["source"] = 'english-bulldog-dog-breed.com'
        ...
        if len(sku_variant)<1:
            ...
            # print(attrs_list)
            headers = {
                'authority': 'www.english-bulldog-dog-breed.com',
                ...
                'accept': '*/*',
                'origin': 'https://www.english-bulldog-dog-breed.com',
                'sec-fetch-site': 'same-origin',
                'sec-fetch-mode': 'cors',
                'sec-fetch-dest': 'empty',
                'accept-language': 'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7,an;q=0.6',
                'cookie': 'zenid=juhjth11a5uqdij5mrplbm54qm; _ga=GA1.2.874772820.1640659349; _gid=GA1.2.2000151874.1640659349; velaro_visitorId=%22X-yM-By7bE6V8D4igfNvyg%22; velaro_firstvisit=%222021-12-28T02%3A42%3A39.49Z%22; velaro_endOfDay=%222021-12-28T23%3A59%3A59.999Z%22; _gat=1; __atuvc=3%7C52; __atuvs=61caadc1635434b6001',
            }
            sku_list = list()
            for attrs in attrs_list:
                ...
                data = {
                    'securityToken': '136633f27167dd311cb77df2cb477715',
                    # 'id[87]': '863',
                    # 'id[92]': '908',
                    # 'id[88]': '881',
                    # 'id[101]': '1545',
                ...
                response = requests.post('https://www.english-bulldog-dog-breed.com/ajax.php', headers=headers, params=params, data=data)
