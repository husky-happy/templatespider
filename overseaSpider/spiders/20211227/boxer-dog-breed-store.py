...
website = 'boxer-dog-breed-store'
website_url = 'https://www.boxer-dog-breed-store.com/'
...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['boxer-dog-breed-store.com']
    start_urls = ['https://www.boxer-dog-breed-store.com/']
    ...
    def parse_detail(self, response):
        ...
        items["source"] = 'boxer-dog-breed-store.com'
        ...
        if len(sku_variant)<1:
            ...
            # print(attrs_list)
            headers = {
                'authority': 'www.boxer-dog-breed-store.com',
                ...
                'accept': '*/*',
                'origin': 'https://www.boxer-dog-breed-store.com',
                'sec-fetch-site': 'same-origin',
                'sec-fetch-mode': 'cors',
                'sec-fetch-dest': 'empty',
                'accept-language': 'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7,an;q=0.6',
                'cookie': 'zenid=6o85kl81124ofm7i5ggtuesa2g; _ga=GA1.2.845842792.1640659736; _gid=GA1.2.320667824.1640659736; enablePopup=popup; velaro_firstvisit=%222021-12-28T02%3A49%3A05.557Z%22; velaro_visitorId=%22Z7V5B7evwUCmPNQGinIZKw%22; __atuvc=2%7C52; __atuvs=61cab395becaa48a000; velaro_endOfDay=%222021-12-28T23%3A59%3A59.999Z%22',
            }
            ...
            for attrs in attrs_list:
                ...
                data = {
                    'securityToken': '4f43cec7bca3700f2c909104ef3a37ed',
                    # 'id[87]': '863',
                    # 'id[92]': '908',
                    # 'id[88]': '881',
                    # 'id[101]': '1545',
                ...
                response = requests.post('https://www.boxer-dog-breed-store.com/ajax.php', headers=headers, params=params, data=data)
