...
# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：templatespider -> doobysdogtoys
@IDE    ：PyCharm
@Author ：Mr. Husky
...
class ThecrossdesignSpider(scrapy.Spider):
    name = website
    allowed_domains = ['doobysdogtoys.com']
    start_urls = ['https://doobysdogtoys.com/']
    ...
    def parse(self, response):
        """获取全部分类"""
        category_urls = ['https://doobysdogtoys.com/shop/cbd-dog-biscuits/',
                         'https://doobysdogtoys.com/fun-gifts/',
                         'https://doobysdogtoys.com/shop/hemp-cat-toys/',
                         'https://doobysdogtoys.com/shop/hemp-dog-toys-1/',
                         'https://doobysdogtoys.com/shop/higher-elevation/']

        category_cate = ['CBD Dog Biscuits',
                        'Fun Gifts',
                        'Hemp Cat Toys',
                        'Hemp Dog Toys',
                        'Higher Elevation']
    ...
    def parse_detail(self, response):
        ...
        cate = response.meta.get("cat")
        price = response.xpath("//div[@class='productView-product']//span[@class='price price--withoutTax']/text()").get()
        ...
        items["source"] = 'doobysdogtoys.com'
        ...
        brand = response.xpath("//h2/a/span/text()").get()
        items["brand"] = brand
